...
import { Card, Form, Button, Table, Row, Col, Tabs, Tab } from 'react-bootstrap';
          ...
          <Tab eventKey="add" title="Adicionar">
            <Form className="mb-3">
              <Row className="g-2">
                ...
                <Col md={2}>
                  <Button variant="primary" onClick={handleAdicionar} className="w-100">
                    Adicionar
                  </Button>
                </Col>
              </Row>
